...
#### 1.2 ファイル命名規則の遵守
```
画像ファイル: step01-setup.jpg, step02-process.jpg, overview.jpg
動画ファイル: step01-setup.mp4, step02-process.mp4, overview.mp4
PDFファイル: drawing.pdf, step01-instruction.pdf
```
